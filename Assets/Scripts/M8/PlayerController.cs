    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        switch (other.gameObject.tag)
        {
            case "pistol":
                ...
                {
                    Weapon pistolWeapon = pistol.GetComponent<Weapon>();
                    if (pistolWeapon != null)
                    {
                        consumePickup = pistolWeapon.TryRefillAmmoFromPickup();
                    }
                }
                break;
            ...
            case "rifle":
                ...
                {
                    Weapon rifleWeapon = rifle.GetComponent<Weapon>();
                    if (rifleWeapon != null)
                    {
                        consumePickup = rifleWeapon.TryRefillAmmoFromPickup();
                    }
                }
                break;
            ...
            case "minigun":
                ...
                {
                    Weapon miniGunWeapon = miniGun.GetComponent<Weapon>();
                    if (miniGunWeapon != null)
                    {
                        consumePickup = miniGunWeapon.TryRefillAmmoFromPickup();
                    }
                }
                break;
            default:
        ...
        if (consumePickup)
        {
            ...
            switch (other.gameObject.tag)
            {
                ...
                case "rifle":
                    ...
                    break;
                case "minigun":
                    weapon = miniGun.GetComponent<Weapon>();
                    break;
            }
